// Deleta OMs específicas da tabela oms_finalizadas (informe os omNumbers)
...
// Informe os omNumbers das OMs a serem removidas:
const omsParaRemover = ['10', '1000']; // Exemplo, edite conforme necessário

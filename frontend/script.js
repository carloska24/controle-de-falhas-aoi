document.addEventListener('DOMContentLoaded', () => {
  ...
  btnDemo.addEventListener('click', async () => {
    ...
    const demoData = [
      ...
      {om:'OM-2025-DEMO3', qtdlote:80, serial:'SN-DEMO5', designador:'C7', tipodefeito:'Solda Fria', pn:'CL10B104KB8NNNC', obs:'Reinspeção'},
    ];
    try {
  ...
  // (Listeners para PDF omitidos por simplicidade, mas a lógica está presente nas funções)
